					...
					function () {
						...
						switch ( $_REQUEST['fortnox_auth_code'] ) {
							case '1':
								...
								$message = __( "Fortnox authentication link expired, please try again.", WF_Plugin::TEXTDOMAIN );
								break;
							case '2':
								$class   = 'notice notice-success';
								$message = __( "Fortnox authentication was successful.", WF_Plugin::TEXTDOMAIN );
								break;
						}
						if ( $message && $class ) {
